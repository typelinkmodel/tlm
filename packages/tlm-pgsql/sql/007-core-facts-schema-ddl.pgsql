...
VALUES ('TLM Core Schema: Facts DDL');
...
CREATE TABLE tlm__link_fact_sets
( -- extends tlm__facts
    -- for plural links
    oid    INTEGER
        REFERENCES tlm__facts (oid)
...
CREATE TABLE tlm__toggle_facts
( -- extends tlm__facts
    oid    INTEGER PRIMARY KEY
        REFERENCES tlm__facts (oid)
            ON DELETE CASCADE,
...
CREATE TABLE tlm__value_fact_sets
( -- extends tlm__facts
    -- for plural values
    oid        INTEGER
        REFERENCES tlm__facts (oid)
