...
INSERT INTO tlm__schema_history (description) VALUES ('TLM Core Schema: DDL');
...
CREATE FUNCTION tlm__select_namespace_oid(ns_prefix VARCHAR)
  ...
  STABLE
  AS $$
      SELECT oid FROM tlm__namespaces
...
CREATE PROCEDURE tlm__insert_type (
  ...
  description  VARCHAR
    ...
    INSERT INTO tlm__types (oid, namespace, name, super, description) VALUES
      (
        tlm__current_oid(),
...
CREATE PROCEDURE tlm__insert_namespace(prefix VARCHAR, uri VARCHAR, description TEXT)
  ...
  AS $$
    ...
    INSERT INTO tlm__namespaces (oid, prefix, uri, description) VALUES
      (tlm__current_oid(), prefix, uri, description);
$$;
